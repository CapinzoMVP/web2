  ...
  return (
    <div className="space-y-16">
      <div className="text-center">
        <h1 className="text-5xl font-extrabold text-accent font-serif">Tentang Perusahaan XYZ</h1>
        <p className="mt-4 text-lg text-content-secondary max-w-2xl mx-auto">Mengenal lebih dekat siapa kami, visi, dan misi kami dalam memimpin industri perhotelan.</p>
      </div>
