...
/**
 * AppContent component manages the main layout and page-level behaviors.
 * - Implements intelligent scroll restoration: scrolls to the top on new page loads
 *   but preserves scroll position when using the browser's back/forward buttons.
 * - Applies a fade-in transition to pages on navigation for a smoother UX.
 */
