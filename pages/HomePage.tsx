      ...
      >
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight leading-tight mb-4 motion-safe:animate-fade-in-down font-serif">
            Menghadirkan Standar Baru dalam <span className='text-accent'>Inovasi & Pelayanan</span>
          </h1>
      ...
      <section className="container mx-auto">
        <div className="grid md:grid-cols-3 gap-8 text-center">
          <div className="flex flex-col items-center p-6">
            ...
            <p className="text-content-secondary">Pengalaman di Industri Hospitality</p>
          </div>
          <div className="flex flex-col items-center p-6">
        ...
        <div className="lg:col-span-2">
          ...
          <div className="space-y-4 mb-6">
            ...
            <div>
              ...
              <p className="text-content-secondary">+62812-3456-7890</p>
            </div>
            <div>
              <h3 className="font-semibold text-accent">Email</h3>
              <p className="text-content-secondary">email.com</p>
            </div>
          </div>
